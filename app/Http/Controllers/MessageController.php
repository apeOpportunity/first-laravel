...
/*    function showSelected($selectedType) {
        $selectedMessages = Message::where('type', $selectedType)->get(); 
        return view('searchResult', ['messageList' => $selectedMessages]); 
    }*/
    ...
    public function update(Request $request, $id) {
        ...
        return redirect('/messages')->with('success', 'Post updated!');
    }
